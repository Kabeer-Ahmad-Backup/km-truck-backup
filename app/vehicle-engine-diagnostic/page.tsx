...
export default function Page() {
  return (
    <ServicePageTemplate
      ...
      extraSections={[
        { title: "Truck Brands:", items: ["Freightliner", "Kenworth", "Peterbilt", "Mack Trucks", "Western Star", "International Trucks", "Volvo Trucks", "Hino Motors", "Isuzu", "UD Trucks", "Ford Trucks", "Chevrolet", "RAM Trucks", "Tesla Semi", "Autocar Trucks"] }
      ]}
